...
@section('content')
    ...
    <h1 class="page-title">
        ...
        <a href="javascript:;" title="Delete" class="btn btn-danger delete" data-id="18" id="delete-18">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="{{ route('admin.course-intake.delete') }}"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($courses as $course)
                                                    <tr role="row" class="odd">
                                                        <td>
                                                            <input type="checkbox" name="row_id" id="checkbox_10"
                                                                value="10">
                                                        </td>
                                                        <td>
                                                            <div>{{ $course->name }}</div>
