...
class CourseController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        //Fetching Courses
		$allLevel = Level::where('status','Published')->get();

        //Selected Courses
		$levelForCourse = [];
		$course_level = CourseLevel::where('course_id',$id)->get();
		foreach($course_level as $level_id){
			$level = Course::find($level_id->level_id);
			if($level){
				$levelForCourse[] = $level;
			}
		}
		
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allLevel','levelForCourse'));
    }
    ...
    public function update(Request $request, $id)
    {
		...
		$this->updateCourseLevel($request,$id);
    ...
    public function store(Request $request)
    {
        ...
        foreach($request->level as $levels):
            //var_dump($cat);
	...
	protected function updateCourseLevel($request,$id){
		if($request->level){
