...
class UniversityController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        //Fetching Courses
		$allCourses = Course::where('status','Published')->get();
		
        //Selected Courses
		$coursesForUniversity = [];
		$course_university = CourseUniversity::where('university_id',$id)->get();
		foreach($course_university as $courses_id){
			$courses = Course::find($courses_id->course_id);
			if($courses){
				$coursesForUniversity[] = $courses;
			}
		}
		
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allCourses','coursesForUniversity'));
    }
    ...
    public function update(Request $request, $id)
    {
		...
		CourseUniversity::where('university_id',$id)->delete();
		
		$this->updateUniversityCourses($request,$id);
    ...
    public function store(Request $request)
    {
        ...
        foreach($request->courses as $courses):
            //var_dump($cat);
            $course = CourseUniversity::create([
	...
	protected function updateUniversityCourses($request,$id){
		if($request->courses){
